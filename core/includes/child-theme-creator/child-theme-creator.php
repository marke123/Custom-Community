	...
	function showThemePage() {
		...
		if ( !empty($_POST['theme_name']) ) {
			...
			if ( is_wp_error( $result ) ) {
				...
				add_action('admin_notices', printf( __('Theme generated and <a href="%s">Theme switched!</a>', 'one-click-child-theme'), admin_url( 'themes.php' ) ));
		...
		locate_template( array( '/core/includes/child-theme-creator/panel.php' ), true );
	}
