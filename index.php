		...
		<?php } else {
			echo '<div class="home_widgets_container">';
 			for ($ln = 1; $ln <= $tkf->home_widgets_lines_number; $ln++ ){ 
 				echo '<div class="home_widget_line widgetarea line_' . $ln . ' widgets_amount_'.$tkf->home_widgets_lines_number.'">';
 				
 				for ($wn = 1; $wn <= $tkf->home_widgets_line_widgets_number[$ln]; $wn++ ){
						
					if( ! dynamic_sidebar( 'home_widget_line_'.$ln.'_widget_'.$tkf->home_widgets_line_widgets_number[$ln] )) : ?>
							<div class="widget">
